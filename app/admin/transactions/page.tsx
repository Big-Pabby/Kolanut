...
export default function AdminTransactionsPage() {
  ...
  const rows = useMemo(() => {
    ...
    return adminTransactionsByRecency(activeTab).filter((row) => {
      const matchesQuery =
        !query ||
  ...
  const totalForTab = adminTransactionsByRecency(activeTab).length;
      ...
      <div className="mx-auto space-y-6">
        ...
        <div className="border border-[#F3F4F6] bg-white p-4 rounded-[8px]">
          ...
          <p className="text-sm text-[#6B7280] mt-0.5">
            Premium payments and claim settlements across all customers
          </p>
        </div>
          ...
          <CardContent className="p-4 space-y-4">
            ...
            <div className="flex flex-col gap-3 border-b border-[#E5E7EB] pb-4 lg:flex-row lg:items-center">
              <div className="relative w-full lg:max-w-[380px]">
                ...
                <Input
                  placeholder="Search by customer, payment ID or policy number"
                  value={searchQuery}
                      ...
                      >
                        ...
                        <TableCell className="py-3.5 pr-5">
                          <Button
                            ...
                            onClick={() =>
                              router.push(
                                `/admin/transactions/${row.paymentId}`,
                              )
                            }
                          >
