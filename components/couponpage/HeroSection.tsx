			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center ">
				...
				<div className="flex flex-col gap-6 ">
					...
					<h1 className="font-heading text-3xl md:text-4xl lg:text-5xl font-semibold leading-tight text-dark-text">
						...
						<span className="text-brand-red">Give them protection.</span>
					</h1>

					<p className="text-base md:text-lg -mt-[10px] text-body-text max-w-xl">
						With Kolanut Africa, businesses can give their customers access to
						valuable insurance benefits through simple digital coupons.
					</p>

					<div className="flex flex-wrap items-center gap-4 -mt-[6px]">
						<Button
							className="rounded-full bg-brand-red text-white text-sm font-medium px-6 py-2.5 hover:bg-brand-red/90"
						...
						<Button
							variant="outline"
							className="rounded-full border border-brand-red bg-transparent text-brand-red text-sm font-medium px-6 py-2.5 hover:bg-brand-red/5"
				...
				<div className="relative w-full aspect-[4/3] rounded-2xl overflow-hidden bg-[#F4E9EA]">
					<Image
						src="/images/insurance-coupon.png"
