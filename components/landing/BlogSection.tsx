...
const articles = [
  {
    ...
    desc: "Your introduction to property insurance essentials. Learn about coverage types, policy terms, and pre...",
  },
  {
    image: "/images/article.png",
    category: "Category",
    ...
    <section className="bg-white py-10 lg:py-20">
      <div className="mx-auto max-w-[1440px] px-4 lg:px-20">
          ...
          {articles.map((article, i) => (
            ...
            >
              ...
              <div className="flex flex-col gap-3 lg:gap-4 border-b border-l border-r border-card-border rounded-b-lg p-3 lg:p-4">
                ...
                <a
                  href="#"
                  className="flex items-center gap-2 text-sm lg:text-base font-medium text-brand-red hover:opacity-80 transition-opacity"
                >
                  Read More
                  <ArrowRight
                    width={13}
        ...
        <div className="flex justify-center">
          <Button className="rounded-full bg-brand-red !py-2.5 !px-6 lg:!py-3 lg:!px-10 text-sm lg:text-base font-medium text-white hover:bg-brand-red/90 h-auto">
